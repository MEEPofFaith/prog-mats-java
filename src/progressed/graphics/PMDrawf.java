...
public class PMDrawf{
     ...
     * @author MEEP
     * */
    public static void draw3D(float x1, float y1, float x2, float y2, float baseHeight, float height, Color baseColor, Color topColor){
    ...
    public static void draw3D(float x1, float y1, float x2, float y2, float height, Color baseColor, Color topColor){
        draw3D(x1, y1, x2, y2, 0f, height, baseColor, topColor);
    }
