...
public class ItemTurretModule extends ItemTurret implements TurretModule{
    ...
    public class ItemTurretModuleBuild extends ItemTurretBuild implements TurretModuleBuild{
