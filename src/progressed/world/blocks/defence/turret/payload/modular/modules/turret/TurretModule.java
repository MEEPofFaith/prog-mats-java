...
//You know, I wish there was a way to do this without copying THE ENTIRETY of Turret
public class TurretModule extends ReloadTurretModule{
    ...
    public DrawBlock drawer = new DrawTurretModule();
    ...
    public void setBars(){
        ...
        if(heatRequirement > 0){
            addModuleBar("heat", (TurretModuleBuild entity) ->
                new Bar(() ->
    ...
    public class TurretModuleBuild extends ReloadTurretModuleBuild implements ControlBlock{
