...
public class PowerTurretModule extends PowerTurret implements TurretModule{
    ...
    public class PowerTurretModuleBuild extends PowerTurretBuild implements TurretModuleBuild{
