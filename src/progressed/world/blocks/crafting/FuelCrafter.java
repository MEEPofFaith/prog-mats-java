...
public class FuelCrafter extends GenericCrafter{
    ...
    public void drawPlace(int x, int y, int rotation, boolean valid){
        ...
        drawPlaceText(Core.bundle.format("bar.fc-fuelUse",
            amount > 0 ? amount : Core.bundle.get("bar.fc-fuel.unneeded")), x, y, valid);
    }
    ...
    public void setBars(){
        ...
        bars.add("fuel", (FuelSmelterBuild entity) -> new Bar(
            () -> Core.bundle.format("bar.fc-fuel", entity.fuelNeeded() > 0 ? entity.fuel : Core.bundle.get("bar.fc-fuel.unneeded")),
            () -> Pal.lightOrange,
